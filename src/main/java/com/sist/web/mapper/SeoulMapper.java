...
@Repository // 메모리 할당 => Spring이 관리 가능하게
/*
 * 		Spring => 클래스 관리 (Container)
 *                의존성이 낮은 프로그램 (수정 할 때 다른 클래스에 영향 x)
 *        *** 어떤 클래스 관리
 *            VO / Entity
 *             |      |
 *             --------
...
public interface SeoulMapper {
	 ...
	 *                                 | => SNS 로그인
	 *              Spring-Batch    : 스케줄러 
	 *              Spring-Data / Spring-AI / Spring-Integration / Spring-Kafka
	 *              -----------   ---------                        ------------
	 *              MSA 
